...
<!-- 
         <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="ket_prdk" placeholder="Keterangan">
        </div>

        </div>
 -->
     <!--  <div class="form-group row">
         <label for="" class="col-sm-4 col-form-label">HARGA PRODUK</label>
         <div class="col-sm-10">
          <input name="harga_produk"  placeholder="Nama produk"  type="number" class="form-control">    
       </div>
     </div>
      -->
    </p>
